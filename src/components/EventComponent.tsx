    ...
    switch (e.type) {
        case "TeamScored":
            ...
            for (let s of e.teamScores) {
                ...
                facultyVs.push(<p key={teamFaculty.id}>VS</p>)
            }
        ...
        case "ParticipantScored":
            ...
            eventContent = <div>
                ...
                {e.participantScoredTeams.map((team) => {
                        ...
                        let participantScores = e.participantScores.filter(s => participantIds.includes(s.participantId));
                        ...
                        return <div key={team.id}>
                            ...
                            <ul>
                                {participantScores.map(p => {
                                    ...
                                    if (!participant)
                                        throw new Error(`Participant ${p.participantId} not found`);
            ...
            if (e.compositionScores) {
                compositionScore = <div>
                    ...
                    {e.composedTeams.map(t => {
                        ...
                        let teamCompScores = e.compositionScores!.filter(s => teamCompositions.map(c => c.id).includes(s.compositionId));
